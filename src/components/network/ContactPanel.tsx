...
import { X, Mail, Phone, Building2, Briefcase, Calendar, MessageSquare, Gift, Pencil, FileText, Users, MoreHorizontal, Trash2, ChevronLeft } from 'lucide-react';
...
import { AddOpportunityForm } from '@/components/contacts/AddOpportunityForm';
...
export function ContactPanel({ contact, onClose, onLogConversation, onEdit }: ContactPanelProps) {
  ...
  // Show opportunity form view
  if (showOpportunityForm) {
    return (
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-card border-l border-border shadow-lg z-50 animate-slide-in-right flex flex-col">
        {/* Header */}
      ...
      <ScrollArea className="flex-1">
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => setShowOpportunityForm(true)}>
